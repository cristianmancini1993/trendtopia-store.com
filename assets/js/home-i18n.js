...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      hero_title: 'Products chosen with care, so you don\'t have to search.',
      hero_subtitle: 'We take care of every detail, from selection until your order reaches your door. Delivery in 24–48 business hours and cash on delivery: you take no risk.',
    ...
    es: {
      ...
      hero_title: 'Productos elegidos con cuidado, para que tú no tengas que buscar.',
      hero_subtitle: 'Cuidamos cada detalle, desde la selección hasta que el pedido llega a tu puerta. Entrega en 24–48 h laborables y pago contra reembolso: no arriesgas nada.',
    ...
    pt: {
      ...
      hero_title: 'Produtos escolhidos com cuidado, para que não tenha de procurar.',
      hero_subtitle: 'Cuidamos de cada pormenor, desde a seleção até a encomenda chegar à sua porta. Entrega em 24–48 h úteis e pagamento à cobrança: não arrisca nada.',
    ...
    pl: {
      ...
      hero_title: 'Produkty wybrane z troską, dzięki czemu nie musisz szukać.',
      hero_subtitle: 'Dbamy o każdy szczegół — od wyboru po dostawę pod Twoje drzwi. Dostawa w 24–48 h roboczych i płatność przy odbiorze: zero ryzyka.',
    ...
    gr: {
      ...
      hero_title: 'Επιλεγμένα προϊόντα με προσοχή, ώστε εσείς να μη χρειάζεστε να ψάχνετε.',
      hero_subtitle: 'Φροντίζουμε κάθε λεπτομέρεια, από την επιλογή μέχρι την παράδοση στην πόρτα σας. Παράδοση σε 24–48 ώρες εργασίας και αντικαταβολή: χωρίς ρίσκο.',
    ...
    sk: {
      ...
      hero_title: 'Produkty starostlivo vybrané, aby ste nemuseli hľadať.',
      hero_subtitle: 'Staráme sa o každý detail — od výberu až po doručenie k vašim dverám. Doručenie do 24–48 pracovných hodín a platba na dobierku: bez rizika.',
    ...
    cz: {
      ...
      hero_title: 'Produkty pečlivě vybrané, abyste nemuseli hledat.',
      hero_subtitle: 'Pečujeme o každý detail — od výběru až po doručení k vašim dveřím. Doručení do 24–48 pracovních hodin a platba na dobírku: bez rizika.',
      hero_cta: 'Naše produkty',
