...
LOCALES = {
 ...
 "offer_name": "Vortek ES 1013 (CPL)", "lp_id": "es-vortek-1013",
 "logo_html": "VOR<span>TEK</span>", "product_value": "Vortek",
 ...
 "title": "Vortek™ — Kit completo con 50 % de descuento",
 "desc": "Vortek: motosierra a batería con motor sin escobillas, dos baterías y kit completo. Oferta del 50 % y pago contra reembolso.",
 ...
 "hero_alt": "Kit completo de motosierra Vortek con baterías, cadenas, cargador, maletín y guantes de regalo",
 "hero_alt": "Kit completo de motosierra Vortek con baterías, cadenas, cargador, maletín y guantes",
 "badge_small": "OFERTA",
 "pack_label": "KIT COMPLETO INCLUIDO",
 "pack_small": "2 baterías · 2 cadenas · maletín · guantes de regalo",
 "form_eye": "Oferta de lanzamiento",
 "form_h2": "PIDE TU VORTEK",
 ...
 "prob_p": "Vortek combina un motor sin escobillas con dos baterías intercambiables. Cuando una se agota, colocas la otra y continúas.",
 ...
 "feat_p": "Tres razones por las que el kit Vortek está pensado para trabajos de poda y corte en jardines y terrenos.",
 ...
 "f1alt": "Persona cortando un tronco con la motosierra Vortek",
 ...
 "f2alt": "Corte de un tronco con la motosierra Vortek",
 ...
 "f3alt": "Kit Vortek con baterías y cargador en el taller",
 "cmp_eye": "Comparación objetiva",
 "cmp_h2": "VORTEK FRENTE A UN MODELO BÁSICO",
 "cmp_p": "Comparación del kit Vortek frente a una motosierra básica de jardín.",
 "cmp_h": "Característica", "cmp_a": "Vortek", "cmp_b": "Modelo básico",
 ...
 "pack_alt": "Contenido completo del pack Vortek",
 "li1": "1 motosierra Vortek", "li2": "2 baterías de litio", "li3": "1 cargador rápido",
 ...
 "rev_note": "Opiniones de clientes sobre el uso de Vortek. La autonomía y el corte dependen de la madera y las condiciones de trabajo.",
 ...
 "ph1": "Kit Vortek sobre la mesa al desembalar",
 "ph2": "Motosierra Vortek junto a un tronco en el jardín",
 "ph3": "Kit Vortek al desembalarlo en casa",
 ...
 "offer_name": "Vortek PL 3231 (CPL)", "lp_id": "pl-vortek-1429",
 "logo_html": "VOR<span>TEK</span>", "product_value": "Vortek",
 ...
 "title": "Vortek™ — kompletny zestaw z 50% rabatu",
 "desc": "Vortek: pilarka łańcuchowa akumulatorowa z silnikiem bezszczotkowym, dwoma akumulatorami i kompletnym zestawem. 50% rabatu i płatność przy odbiorze.",
 ...
 "hero_alt": "Kompletny zestaw pilarki Vortek z akumulatorami, łańcuchami, ładowarką, walizką i rękawicami",
 "badge_small": "RABAT",
 ...
 "prob_p": "Vortek łączy silnik bezszczotkowy z systemem dwóch akumulatorów pracujących jednocześnie, zapewniając stabilne zasilanie podczas cięcia.",
 ...
 "feat_p": "Trzy powody, dla których zestaw Vortek jest do cięcia i pielęgnacji ogrodu.",
 ...
 "f1alt": "Cięcie pnia pilarką Vortek",
 ...
 "f2alt": "Cięcie pnia pilarką Vortek z bliska",
 ...
 "f3alt": "Zestaw Vortek z akumulatorami i ładowarką w warsztacie",
 "cmp_eye": "Rzetelne porównanie",
 "cmp_h2": "VORTEK W PORÓWNANIU Z PODSTAWOWYM MODELEM",
 "cmp_p": "Porównanie zestawu Vortek z podstawową pilarką ogrodową.",
 "cmp_h": "Cecha", "cmp_a": "Vortek", "cmp_b": "Model podstawowy",
 ...
 "pack_alt": "Pełna zawartość zestawu Vortek",
 "li1": "1 pilarka Vortek", "li2": "2 akumulatory litowe", "li3": "1 szybka ładowarka",
 ...
 "rev_note": "Opinie klientów o użytkowaniu Vortek. Czas pracy i cięcie zależą od drewna i warunków.",
 ...
 "ph1": "Zestaw Vortek na stole po rozpakowaniu",
 "ph2": "Pilarka Vortek przy pniu w ogrodzie",
 "ph3": "Zestaw Vortek po rozpakowaniu",
 ...
 "offer_name": "Vortek LT 1427 (CPL)", "lp_id": "lt-vortek-1427",
 "logo_html": "VOR<span>TEK</span>", "product_value": "Vortek",
 ...
 "cookie_text": "Naudojame techninius ir trečiųjų šalių slapukus, kad pagerintume naršymo patirtį ir rinktumėme analitikos duomenis.",
 "cookie_accept": "Sutinku", "cookie_learn": "Sužinoti daugiau",
 "title": "Vortek™ — visas rinkinys su 50 % nuolaida",
 "desc": "Vortek: akumuliatorinis grandininis pjūklas su bešepetėliniu varikliu, dviem akumuliatoriais ir visu rinkiniu. 50 % nuolaida ir atsiskaitymas pristatymo metu.",
 "announce": "<strong>50 % NUOLAIDA</strong> · 128,00 € → 64,00 € · ATSISKAITYMAS PRISTATYMO METU",
 "ship": "Pristatymas per 24–48 val.*", "cod": "Atsiskaitymas pristatymo metu",
 "rating": "Klientų vertinimas*",
 "eyebrow": "Profesionalus akumuliatorinis grandininis pjūklas",
 "h1": "UŽBAIKITE DARBĄ <em>BE PRIVERSTINIŲ PERTRAUKŲ.</em>",
 "lead": "1 500 W bešepetėlinis variklis, du akumuliatoriai ir visas rinkinys kamienams bei šakoms pjauti – be laido ir benzino.",
 "p1": "<strong>Iki 8 valandų veikimo*</strong> su dviem rinkinyje esančiais akumuliatoriais.",
 "p2": "<strong>Deklaruojamas pjovimo skersmuo iki 40 cm*</strong> – priklausomai nuo medienos ir naudojimo sąlygų.",
 "p3": "<strong>Tik 2,4 kg*</strong> su pjovimo juosta ir akumuliatoriumi.",
 "p4": "<strong>Automatinis grandinės tepimas ir įtempimas*</strong> – mažiau pertraukų.",
 "p5": "<strong>Dovanų pirštinės, apsauginiai akiniai ir naudojimo vadovas</strong> įeina į rinkinį.",
 "hero_alt": "Visas Vortek pjūklo rinkinys su akumuliatoriais, grandinėmis, krovikliu, lagaminu, pirštinėmis ir apsauginiais akiniais",
 "badge_small": "PASIŪLYMAS",
 "pack_label": "VISAS RINKINYS ĮSKAIČIUOTAS",
 "pack_small": "2 akumuliatoriai · 2 grandinės · lagaminas · pirštinės ir akiniai",
 "form_eye": "Specialus pasiūlymas",
 "form_h2": "UŽSISAKYKITE VORTEK",
 "form_p": "Dabar mokėti nereikia. Užsakymą patvirtinsime telefonu, o atsiskaitysite gavę siuntinį.",
 "step1": "1 žingsnis iš 2", "step2": "2 žingsnis iš 2", "secure": "Saugus užsakymas",
 "err": "Užpildykite pažymėtus laukus ir tęskite.",
 "lbl_name": "Vardas ir pavardė", "ph_name": "Pvz. Jonas Kazlauskas",
 "lbl_tel": "Telefonas", "ph_tel": "Pvz. 612 34567",
 "next": "TĘSTI UŽSAKYMĄ →",
 "micro1": "Paskambinsime, kad patvirtintume jūsų duomenis ir pristatymo adresą.",
 ...
 "back": "← Atgal",
 "micro2": "Pateikdami užsakymą sutinkate su <a href=\"/lt/terms-conditions.html\">sąlygomis</a> ir <a href=\"/lt/privacy-policy.html\">privatumo politika</a>.",
 "t1b": "Nuolaida −50%", "t1s": "128,00 € → 64,00 €",
 "t2b": "Atsiskaitymas pristatymo metu", "t2s": "Be išankstinio mokėjimo",
 "t3b": "Pristatymas per 24–48 val.*", "t3s": "Po patvirtinimo telefonu",
 "t4b": "30 dienų*", "t4s": "Grąžinimo teisė",
 "prob_eye": "Dirbkite be įprastų apribojimų",
 "prob_h2": "VIENAS ĮRANKIS. VISA DIENA.",
 "prob_p": "Vortek sujungia bešepetėlinį variklį ir du keičiamus akumuliatorius. Vienam išsikrovus, įstatote kitą ir tęsiate darbą.",
 "m1b": "1 500 W*", "m1s": "Deklaruojama bešepetėlinio variklio galia.",
 "m2b": "2 AKUMULIATORIAI", "m2s": "Juos galite keisti darbo metu.",
 "m3b": "40 CM*", "m3s": "Didžiausias deklaruojamas kamieno skersmuo, priklausomai nuo medienos.",
 "feat_eye": "Sukurtas darbui be pertraukų",
 "feat_h2": "MAŽIAU SUSTOJIMŲ. DAUGIAU NUVEIKTA.",
 "feat_p": "Trys priežastys, kodėl Vortek rinkinys tinka sodo ir sklypo priežiūrai.",
 "f1t": "BEŠEPETĖLINIS VARIKLIS 1 500 W*",
 "f1p": "Sukurtas tolygiam pjovimui ir tam, kad ilgiau dirbant mažiau kaistų. Tikroji pjovimo galia priklauso nuo medienos, grandinės ir įkrovos lygio.",
 "f1c1": "Bešepetėlinis variklis", "f1c2": "Šilumos išsklaidymas", "f1c3": "Darbas sode",
 "f1alt": "Kamieno pjovimas Vortek pjūklu",
 "f2t": "DU AKUMULIATORIAI, KAD GALĖTUMĖTE PJAUTI TOLIAU",
 "f2p": "Du rinkinyje esantys akumuliatoriai kartu užtikrina iki 8 valandų veikimo, o pilnas įkrovimas trunka apie valandą. Tikroji trukmė priklauso nuo medienos rūšies ir storio.",
 "f2c1": "2 akumuliatoriai", "f2c2": "Greitas keitimas", "f2c3": "Kroviklis rinkinyje",
 "f2alt": "Kamieno pjovimas Vortek pjūklu iš arti",
 "f3t": "AUTOMATINIS GRANDINĖS TEPIMAS IR ĮTEMPIMAS*",
 "f3p": "Alyvos bakelis ir sistema, kuri pati reguliuoja grandinės įtempimą, kad rečiau reikėtų stabdyti darbą. Visada laikykitės gamintojo nurodymų.",
 "f3c1": "2 grandinės", "f3c2": "Alyvos bakelis", "f3c3": "Automatinis reguliavimas*",
 "f3alt": "Vortek rinkinys su akumuliatoriais ir krovikliu dirbtuvėse",
 "cmp_eye": "Kuo skiriasi",
 "cmp_h2": "VORTEK PRIEŠ BAZINĮ MODELĮ",
 "cmp_p": "Palyginkite Vortek rinkinį su paprastu sodo pjūklu.",
 "cmp_h": "Savybė", "cmp_a": "Vortek", "cmp_b": "Bazinis modelis",
 "c1": "Akumuliatoriai rinkinyje", "c1a": "✓ 2 vnt.", "c1b": "Dažniausiai 1 vnt.",
 "c2": "Kroviklis", "c2a": "✓ Įskaičiuotas", "c2b": "Priklauso nuo modelio",
 "c3": "Grandinės rinkinyje", "c3a": "✓ 2 vnt.", "c3b": "Dažniausiai 1 vnt.",
 "c4": "Lagaminas ir apsaugos priemonės", "c4a": "✓ Įskaičiuota", "c4b": "Priklauso nuo modelio",
 "c5": "Atsiskaitymas pristatymo metu", "c5a": "✓ Taip", "c5b": "Priklauso nuo modelio",
 "pack_eye": "Viskas įskaičiuota",
 "pack_h2": "ATIDARYKITE LAGAMINĄ IR PRADĖKITE DIRBTI.",
 "pack_alt": "Visas Vortek rinkinio turinys",
 "li1": "1 Vortek grandininis pjūklas", "li2": "2 ličio akumuliatoriai", "li3": "1 greitasis kroviklis",
 "li4": "2 grandinės ir montavimo priedai", "li5": "1 transportinis lagaminas",
 "li6": "Dovanų pirštinės, apsauginiai akiniai ir naudojimo vadovas",
 "safety": "<strong>Sauga:</strong> visada naudokite akių apsaugą, pirštines ir tinkamą įrangą. Perskaitykite visą vadovą ir nenaudokite įrankio, jei nemokate saugiai naudotis grandininiu pjūklu.",
 "rev_eye": "Atsiliepimai", "rev_h2": "KĄ SAKO JAU NAUDOJANTYS PIRKĖJAI.",
 "rev_note": "Klientų atsiliepimai apie Vortek. Veikimo laikas ir pjovimo našumas priklauso nuo medienos ir naudojimo sąlygų.",
 "q1": "“Supjoviau malkas žiemai ir sutvarkiau sodą nelaukdamas kito įkrovimo.”",
 "q2": "“Nustebau, kad pjūklas susitvarko net su storesniais kamienais, tačiau jį vis tiek lengva valdyti.”",
 "q3": "“Dėl nedidelio svorio ilgesnį laiką dirbti lengviau nei su kitais įrankiais, kuriuos esu naudojęs.”",
 "r1n": "Petras K.", "r1c": "Kaunas",
 "r2n": "Rasa V.", "r2c": "Klaipėda",
 "r3n": "Marius S.", "r3c": "Šiauliai",
 "ph1": "Vortek rinkinys ant stalo išpakavus",
 "ph2": "Vortek pjūklas prie kamieno sode",
 "ph3": "Vortek rinkinys išpakavus",
 "faq_eye": "Dažnai užduodami klausimai", "faq_h2": "KĄ VERTA ŽINOTI PRIEŠ UŽSAKANT…",
 "faq_p": "Atsakymai apie akumuliatorius, pjovimą, atsiskaitymą, pristatymą, grąžinimą ir garantiją.",
 "faq": [
 ("Kiek laiko veikia akumuliatoriai?", "Abu akumuliatoriai kartu užtikrina iki aštuonių valandų veikimo. Greitasis kroviklis pilnai įkrauna apie valandą. Tikroji trukmė priklauso nuo medienos storio ir rūšies, pjovimo spaudimo, temperatūros ir akumuliatorių būklės."),
 ("Ar galima pjauti 40 cm kamienus?", "Didžiausias deklaruojamas pjovimo skersmuo – iki 40 cm. Rezultatas priklauso nuo medienos kietumo, pjovimo technikos ir priežiūros."),
 ("Ar turiu mokėti dabar?", "Ne. Atsiskaitote pristatymo metu: užsakymą patvirtiname telefonu, o kurjeriui sumokate gavę siuntinį."),
 ("Kas tiksliai įeina į rinkinį?", "Į rinkinį įeina pjūklas, du akumuliatoriai, kroviklis, dvi grandinės, įrankiai, lagaminas, apsauginiai akiniai, naudojimo vadovas ir dovanų pirštinės."),
 ("Ar galiu grąžinti prekę?", "Taip, per 30 dienų pagal <a href=\"/lt/refund-policy.html\">grąžinimo politiką</a>."),
 ("Kokia garantija?", "24 mėnesių atitikties garantija, galiojanti nuo pristatymo dienos."),
 ],
 "cta_h2": "VORTEK UŽ 64,00 €",
 "cta_p": "Visas rinkinys, 50 % nuolaida ir atsiskaitymas pristatymo metu. Pasiūlymas galioja, kol yra atsargų, ir taikomas patvirtinus užsakymą.",
 "cta_btn": "UŽSISAKYTI DABAR →",
 "foot_p": "Akumuliatorinis pjūklas darbui sode ir lauke.",
 ...
 "rights": "Visos teisės saugomos. *Veikimo laikas ir pjovimo našumas priklauso nuo medienos rūšies bei naudojimo sąlygų. Pristatymo terminas skaičiuojamas nuo užsakymo patvirtinimo.",
 "sticky": "UŽSISAKYKITE VORTEK · 64,00 €",
...
<body>
 ...
 <a class="logo" href="#inicio">{L.get("logo_html", "IRON OAK <span>PRO</span>")}</a>
...
{extra} <input name="uid" type="hidden" value="{UID}">
 ...
 <input type="hidden" name="product" value="{L.get("product_value", "Iron Oak Pro")}">
 </form>
 </aside>
 </div>
 </header>
