...
LOCALES = {
  ...
  "lt": {
    ...
    "desc": "Vortek: akumuliatorinis grandininis pjūklas su bešepetėliu varikliu, dviem akumuliatoriais ir visu rinkiniu. 50 % nuolaida ir apmokėjimas pristatymo metu.",
    ...
    "prob_p": "Vortek jungia bešepetėlį variklį su dviem keičiamais akumuliatoriais. Vienam išsekus, įstatote kitą ir tęsiate.",
    ...
    "feat_p": "Trys priežastys, kodėl Vortek rinkinys skirtas sodo pjovimui ir priežiūrai.",
    ...
    "cmp_h2": "VORTEK PRIEŠ PAGRINDINĮ MODELĮ",
    "cmp_p": "Vortek rinkinio palyginimas su paprastu sodo pjūklu.",
    "cmp_h": "Savybė", "cmp_a": "Vortek", "cmp_b": "Pagrindinis modelis",
    ...
    "rev_note": "Klientų patirtis su Vortek. Veikimo laikas ir pjovimas priklauso nuo medienos ir sąlygų.",
