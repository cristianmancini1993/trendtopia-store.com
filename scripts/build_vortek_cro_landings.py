...
LOCALES = {
  ...
  "lt": {
    ...
    "desc": "Vortek: akumuliatorinis grandininis pjūklas su bešepetėliu varikliu, dviem akumuliatoriais ir visu rinkiniu. 50 % nuolaida ir atsiskaitymas pristatymo metu.",
    ...
    "h1": "UŽBAIKITE DARBĄ, <em>O NE AKUMULIATORIŲ.</em>",
    "lead": "1 500 W bešepetėlis variklis, du akumuliatoriai ir visas rinkinys kamienams bei šakoms pjauti – be laido ir benzino.",
    ...
    "p5": "<strong>Dovanų pirštinės</strong> įeina į rinkinį.",
    "hero_alt": "Visas Vortek pjūklo rinkinys su akumuliatoriais, grandinėmis, krovikliu, lagaminu ir pirštinėmis",
    ...
    "prob_p": "Vortek sujungia bešepetėlį variklį ir du keičiamus akumuliatorius. Vienam išsekus, įstatote kitą ir tęsiate darbą.",
    ...
    "feat_eye": "Sukurta darbui be pertraukų",
    ...
    "f1p": "Sukurtas tolygiam pjovimui ir mažesniam perkaitimui ilgesnio darbo metu. Tikroji pjovimo galia priklauso nuo medienos, grandinės ir įkrovos lygio.",
    "f1c1": "Bešepetėlis variklis", "f1c2": "Šilumos išsklaidymas", "f1c3": "Darbas sode",
    ...
    "cmp_p": "Kaip Vortek rinkinys atrodo palyginti su paprastu sodo pjūklu.",
    ...
    "c4": "Lagaminas ir apsauga", "c4a": "✓ Įskaičiuota", "c4b": "Priklauso nuo modelio",
